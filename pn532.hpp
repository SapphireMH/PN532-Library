...
public:
	...
	//I2C constructor.
	pn532( hwlib::i2c_bus & i2c_bus, hwlib::target::pin_out & rst, hwlib::target::pin_in irq = hwlib::target::pins::d10, const bool irq_present = false, const uint8_t & addr = 0x24 );
	
	//SPI constructor.
	pn532( hwlib::spi_bus_bit_banged_sclk_mosi_miso & spi_bus, hwlib::target::pin_out sel, hwlib::target::pin_out rst, hwlib::target::pin_in irq = hwlib::target::pins::d10, const bool irq_present = false );
